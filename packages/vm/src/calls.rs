...
use crate::imports::{get_all_time, get_db_read, get_detail, reset_db_read};
    ...
    Q: Querier + 'static,
{
    ...
    let (write_region,write_to_contract)=get_detail();
    ...
    println!("write_to_contract -> call_function {:?} write_region {:?}",write_region,write_to_contract);
    Ok(data)
}
